...
I work across **Express.js, Node.js, React.js, FastAPI, Spring Boot and PostgreSQL/MongoDB**, with hands-on experience building **RAG pipelines and multi-agent systems** end to end.
...
### 📦 StockLedger
**Inventory & Order Management Platform**<br/>
*Run a business's catalog, stock and orders — with every movement auditable.*
...
- **Row-locked order placement** — two staff racing on the last unit resolve correctly, with idempotency keys blocking duplicate submits
- **Append-only stock ledger** — every movement recorded with a running balance, so current stock is derivable rather than asserted
- Scoped data access across **Owner / Manager / Staff** roles — a wrong-org record returns 404, not 403
- Razorpay webhooks verified against **raw request bytes**; refresh-token rotation with reuse detection

[![Repo](https://img.shields.io/badge/Code-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/mars-alien/StockLedger)
[![Live](https://img.shields.io/badge/Live_Demo-000000?style=flat-square&logo=vercel&logoColor=white)](https://stock-edger.vercel.app)
...
<table align="center">
  <tr>
    <td valign="middle">
      <img height="200" src="https://github-readme-stats-seven-tau-38.vercel.app/api?username=mars-alien&show_icons=true&theme=tokyonight&include_all_commits=true&custom_title=Overview&border_color=2C5364&border_radius=10&icon_color=BF91F3&title_color=70A5FD&text_color=38BDAE" alt="GitHub stats" />
    </td>
    <td valign="middle">
      <img height="200" src="https://github-readme-stats-seven-tau-38.vercel.app/api/top-langs/?username=mars-alien&layout=donut&theme=tokyonight&langs_count=6&size_weight=0.5&count_weight=0.5&custom_title=Top%20Languages&border_color=2C5364&border_radius=10&title_color=70A5FD&text_color=38BDAE&exclude_repo=gamebase&hide=jupyter%20notebook,objective-c,c,shell" alt="Top languages" />
    </td>
  </tr>
</table>
