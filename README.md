...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=F75C7E&center=true&vCenter=true&width=460&lines=CSE+Student+at+IIIT+Manipur;Backend+%26+Full-Stack+Engineer;Applied+AI+%2F+RAG+%7C+LLMs;Building+Scalable+%26+Secure+Systems)](https://git.io/typing-svg)

**Backend & Full-Stack Engineer · Applied AI / RAG · Competitive Programmer**
...
- 🧠 Engineered a **hybrid BM25 + HNSW retriever** with Reciprocal Rank Fusion (BAAI/bge-m3, 1024-dim) in **Weaviate**, evaluated with RAGAS metrics
- 🔬 Built an end-to-end **multi-bit watermarking system for LLMs** with deterministic hashing and Z-score detection
...
| Role | Company | Period |
|---|---|---|
| **Backend Developer Intern** | Atal Innovation Centre, Delhi | Jun 2024 – Jan 2025 |

🎓 **B.Tech, Computer Science & Engineering** — IIIT Manipur · Sep 2023 – Aug 2027
...
**Interactive Video Learning Platform** — `React` · `Node.js` · `MongoDB` · `OAuth 2.0`
MERN platform with OAuth (Google / GitHub), JWT sessions, SendGrid email verification, and a clean MVC Express backend using TTL-indexed verification codes and centralized error logging.
...
- 🥈 **AIR 2 — Engineer's Ring of Honour (EROH) 2025** by Naukri.com, among IIT / IIIT / NIT participants — awarded a scholarship and featured in *Times of India*
- 🌍 Ranked **5,204 globally** at **Meta Hacker Cup 2025**, clearing Round 1 among hundreds of thousands of competitors
- 📡 Selected among the **top 3 proposals** at IIIT Manipur for the **5G Innovation Hackathon 2025** by DoT, Government of India
- 🎯 Qualified **GATE CS 2026**
- 💻 Solved **350+ DSA problems** across LeetCode, Codeforces, CodeChef, and GeeksforGeeks
